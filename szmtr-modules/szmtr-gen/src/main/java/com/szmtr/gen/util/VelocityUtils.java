...
public class VelocityUtils {
    ...
    public static List<String> getTemplateList(String tplCategory, String tplWebType) {
        ...
        templates.add("vm/java/dto.java.vm");  // 关键点1：将模板加入渲染列表
        templates.add("vm/java/query.java.vm");  // 关键点1：将模板加入渲染列表
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        if (template.contains("sub-domain.java.vm") && StringUtils.equals(GenConstants.TPL_SUB, genTable.getTplCategory())) {
            ...
            fileName = StringUtils.format("{}/dto/query/{}Query.java", javaPath, className);
        }else if(template.contains("convert.java.vm")){
            fileName = StringUtils.format("{}/domain/convert/{}ModelConvert.java", javaPath, className);
        }
        return fileName;
    }
