package com.szmtr.gen.controller;
...
import com.szmtr.gen.service.IGenTableColumnService;
import com.szmtr.gen.service.IGenTableService;
...
//    @RequiresPermissions("tool:gen:code")
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"szmtr.zip\"");
