...
//import com.szmtr.system.api.domain.SysDictData;
//import com.szmtr.system.service.ISysDictDataService;
//import com.szmtr.system.service.ISysDictTypeService;
//
///**
// * 数据字典信息
// *
...
//     */
//    @PostMapping("/types")
//    public AjaxResult selectDictDataByTypes(@RequestBody Set<String> dictTypes) {
//        Map<String, List<SysDictData>> data = dictDataService.selectDictDataByTypes(dictTypes);
